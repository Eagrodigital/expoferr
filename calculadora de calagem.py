...
l_Ca = Label(frame_esquerda,   text='Ca (cmol/dm3)', width=20, height=1, padx=0,pady=3, relief='flat', font=('Ivy 12 bold'), bg=cor3, fg=cor4)
l_Ca.place(x=2, y=32)

e_Mg = Entry(frame_esquerda, width=10, font=('Ivy 12 bold'), justify='center', relief=SOLID, fg=cor1)
e_Mg.place(x=210, y=62, height=25)

l_Mg = Label(frame_esquerda, text='Mg (cmol/dm3)', width=20, height=1, padx=0,pady=3, relief='flat', font=('Ivy 12 bold'), bg=cor3, fg=cor4)
l_Mg.place(x=2, y=62)

e_K = Entry(frame_esquerda,   width=10, font=('Ivy 12 bold'), justify='center', relief=SOLID, fg=cor1)
e_K.place(x=210, y=92, height=25)

l_K = Label(frame_esquerda, text='K (mg/dm3)', width=20, height=1, padx=0,pady=3, relief='flat', font=('Ivy 12 bold'), bg=cor3, fg=cor4)
l_K.place(x=2, y=92)
...
l_AlH = Label(frame_esquerda, text='Al+H (cmol/dm3)', width=20, height=1, padx=0,pady=3, relief='flat', font=('Ivy 12 bold'), bg=cor3, fg=cor4)
...
l_P = Label(frame_esquerda, text='Fósforo (mg/dm3)', width=20, height=1, padx=0,pady=3, relief='flat', font=('Ivy 12 bold'), bg=cor3, fg=cor4)
l_P.place(x=2, y=152)

e_v2 = Entry(frame_esquerda, width=10, font=('Ivy 12 bold'), justify='center', relief=SOLID, fg=cor1)
e_v2.place(x=210, y=182, height=25)

l_Saturação_desejada = Label(frame_esquerda, text='Saturação desejada (%)', width=20, height=1, padx=0,pady=3, relief='flat', font=('Ivy 12 bold'), bg=cor3, fg=cor4)
...
l_PRNT = Label(frame_esquerda, text='PRNT (%)', width=20, height=1, padx=0,pady=3, relief='flat', font=('Ivy 12 bold'), bg=cor3, fg=cor4)
